...
@bot1.on(sudo_cmd(incoming=True, allow_sudo=True))
@bot2.on(sudo_cmd(incoming=True, allow_sudo=True))
@bot3.on(sudo_cmd(incoming=True, allow_sudo=True))
@bot4.on(sudo_cmd(incoming=True, allow_sudo=True))
async def _(event):
    global que
    if not que.get(event.sender_id):
        return
...
@bot1.on(sudo_cmd(pattern="replyraid(?: |$)(.*)", allow_sudo=True))
@bot2.on(sudo_cmd(pattern="replyraid(?: |$)(.*)", allow_sudo=True))
@bot3.on(sudo_cmd(pattern="replyraid(?: |$)(.*)", allow_sudo=True))
@bot4.on(sudo_cmd(pattern="replyraid(?: |$)(.*)", allow_sudo=True))
async def _(event):
    global que
    if event.fwd_from:
        return
    if event.reply_to_msg_id:
        ...
        que[await event.client.get_entity(await event.get_reply_message().sender_id).id] = []
        que.get(await event.client.get_entity(await event.get_reply_message().sender_id).id).append([await event.client.get_entity(await event.get_reply_message().sender_id).id])
        await event.edit("sᴛᴀʀᴛ ғᴜᴄᴋɪɴɢ ʙʏ ᴅᴀʀᴋ ᴡᴇʙ")
    else:
        event = await edit_or_reply(event, "sᴛᴀʀᴛ ғᴜᴄᴋɪɴɢ ʙʏ ᴅᴀʀᴋ ᴡᴇʙ")
        que[await event.client.get_entity(event.pattern_match.group(1)).id] = []
        que.get(await event.client.get_entity(event.pattern_match.group(1)).id).append([await event.client.get_entity(event.pattern_match.group(1)).id])
        await event.edit("DONT BE OVERSMART ᴅᴀʀᴋ ᴡᴇʙ")
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        queue = que.get(e)
        queue.pop(0)
        await event.edit("ᴅᴀʀᴋ ᴡᴇʙ sᴛᴏᴘ ʀᴀɪᴅ")
    else:
        ...
        queue = que.get(e)
        queue.pop(0)
        await event.edit("STOPPING RAID BY ᴅᴀʀᴋ ᴡᴇʙ")


@bot.on(admin_cmd(pattern="raid (.*)"))
@bot.on(sudo_cmd(pattern="raid (.*)", allow_sudo=True))
@bot1.on(sudo_cmd(pattern="raid (.*)", allow_sudo=True))
@bot2.on(sudo_cmd(pattern="raid (.*)", allow_sudo=True))
@bot3.on(sudo_cmd(pattern="raid (.*)", allow_sudo=True))
@bot4.on(sudo_cmd(pattern="raid (.*)", allow_sudo=True))
async def spam(e):
